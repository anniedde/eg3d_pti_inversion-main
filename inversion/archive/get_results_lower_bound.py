...
for fileName in image_paths:
    if fileName.endswith('.png'):
        ...
        embedding_folder = 'luchao_lower_bound_test_t{}'.format(t)
...
with open('/playpen-nas-ssd/awang/eg3d_pti_inversion-main/inversion/out/reconstruction-t{}.json'.format(t), 'w') as out:
    json.dump(time_result, out)
